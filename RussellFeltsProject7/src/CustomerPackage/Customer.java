...
public class Customer {
    ...
    public Customer(String sFirstName, String sLastName, String sSocSecNum) throws InvalidCustomerException{
        this.sFirstName = sFirstName;
        this.sLastName = sLastName;
        if(!verifySSN(sSocSecNum)){
            this.sSocSecNum = "xxx-xx-xxxx";
            InvalidCustomerException exception = new InvalidCustomerException(sFirstName,sLastName, sSocSecNum);
            throw exception;
        } 
        else 
